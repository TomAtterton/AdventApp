...
const Home = ({}) => {
  const currentCalendar = useAppSelector(
    state => state.calendar.currentCalendar || defaultAdvent,
  );
  ...
  return (
    <View style={[styles.container, {paddingTop: 0}]}>
      ...
      <SnowFall />
      <Button
        style={[styles.settingsButton, {top: top}]}
        onPress={onNavigateToSettings}>
        <Ionicons name="ios-settings-sharp" size={32} color="white" />
      </Button>
      <AdventList
        style={{paddingTop: adventListTopPadding}}
